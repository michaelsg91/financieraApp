...
public class jpanelAriVf extends JPanel{
	private JLabel vf,a,i,n,g,lim1,lim2;
	public JTextField cvf,ca,ci,cn,cg,clim1,clim2;
	public JLabel res;
	...
	public jpanelAriVf(){
		...
		add(vf);add(a);add(i);add(n);add(g);add(lim1);add(lim2);
		add(cvf);add(ca);add(ci);add(cn);add(cg);add(clim1);add(clim2);
